...
export default function GarbageBillForm() {
  ...
  async function handleSubmit(e) {
    ...
    if (!(Number(form.amount) > 0)) errs.push('Amount must be greater than zero.')
    setErrors(errs)
    ...
    await supabase.from('garbage_bills').insert({
    ...
    navigate('/garbage-bills')
  }

  return (
    <Layout title="Add Garbage Bill">
      <div className="card form-card">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-actions">
            ...
            <Link to="/garbage-bills" className="btn btn-outline">Cancel</Link>
          </div>
        </form>
      </div>
    </Layout>
